			...
			<div class="wrap">
				<div class="content-1024">
					<div class="col-1024">
						...
						<form name="form1" method="get" onsubmit="return isEmpty()" action="/airplan_repo/createUser.action">
							...
							<div class="inputs-wide">
								<p><input name="name" class="textbox-gen" id="name" type="text" value="" /></p>
								<p><input name="emailAddress" class="textbox-gen" id="emailAddress" type="email" value="" /></p>
								<p><input name="password" class="textbox-gen" id="password" type="password" value="" /></p>
								<p><input name="passwordCopy" class="textbox-gen" id="passwordCopy" type="password" value="" /></p>
