			...
			<div class="wrap">
				<div class="content-1024">
					<div class="col-1024">
						...
						<legend>Search for Return Flight</legend>
							<form name="form1" method="get" onsubmit="return isEmpty()" action="/airplan_repo/searchFlightsLoop.action">
								<div class="labels">
								...
								<div class="inputs">
									...
									<input name="destination" class="textbox-gen places" id="destination" value=${destination} type="text" />
									<input name="origin" class="textbox-gen places" id="origin" value=${origin} type="text" />
