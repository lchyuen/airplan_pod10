			...
			<div class="wrap">
				<div class="content-1024">
					<div class="col-1024">
						...
						<div class="col-600">
							<a href="staffViewBooking.action?sessionToken=${sessionToken}&bookingId=${ticket.bookingId}&customerToken=${customerToken}"><button type="submit" class="positive btn-gen fl-r" />Return to Booking List</button></a>
						</div>
						<div class="p-basic"></div>
					</div>
				</div>
