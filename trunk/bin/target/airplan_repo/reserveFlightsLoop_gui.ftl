			...
			<div class="header alt-font" style="background-image:url(imgs/1.png)">
				...
				<div class="header-links">
					...
					<ul class="header-menus fs-m menu">
						<li class="header-menu mm-item mm-item-link-sel hand" onclick="return youSure();window.location.href=''">Search / Reserve Flights</a>
						</li>
				...
				<div class="content-1024">
					<div class="col-1024">
						...
						<legend>Reservation Details</legend>
							<form name="form1" method="get" onsubmit="return isEmpty()" action="/airplan_repo/reserveFlightsLoop.action">
								<div class="labels">
