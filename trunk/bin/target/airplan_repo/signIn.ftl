					...
					<div class="col-1024">
						...
						<form name="form1" method="get" onsubmit="return isEmpty()" action="login.action">
							...
							<div class="inputs-wide">
								...
								<p class="ta-c">
									<input type="submit" class="positive btn-gen fl-c" value="Login" /> | <a href="staffSignIn.action">Administrator?</a>
									<br><a href="createUserInput.action">I am a new customer...</a>
								</p>
							</div>
						</form>
						</fieldset>
