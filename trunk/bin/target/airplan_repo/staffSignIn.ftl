			...
			<div class="wrap">
				<div class="content-1024">
					<div class="col-1024">
						...
						<legend>Login</legend>
						<form name="form1" method="get" onsubmit="return isEmpty()" action="stafflogin.action">
							...
							<div class="inputs-wide">
								...
								<p class="ta-c">
									<input type="submit" class="positive btn-gen fl-c" value="Login" /> | <a href="signIn.action">Not Administrator?</a>
								</p>
							</div>
						</form>
						</fieldset>
