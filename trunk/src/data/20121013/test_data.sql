...
(now(), now(), "user1", "user1@hotmail.com", "46f06d8e2be990ad", "eaa4fba3-5009-48", 3594, 0, "e68f758e5bb2aaaa",now()),
(now(), now(), "user2", "user2@hotmail.com", "7a1ecf56da38e807", "a5c2470b-bdb7-49", 3594, 0, "c49d605d5d6fe873",now()),
...
INSERT INTO booking(date_created, date_modified, user_id, cancel_state) VALUES
(now(), now(), 1, 1),
(now(), now(), 2, 1),
(now(), now(), 1, 0),
(now(), now(), 2, 0),
...
(15, 3, 1, 'No Preference', 'No Preference', 'Danny', 599, 2),
(16, 3, 2, 'No Preference', 'No Preference', 'Kevin', 2995, 2),

(17, 4, 1, 'No Preference', 'No Preference', 'Danny', 599, 2),
(18, 4, 2, 'No Preference', 'No Preference', 'Kevin', 2995, 2),

(19, 5, 1, 'No Preference', 'No Preference', 'Danny', 599, 3),
(20, 5, 2, 'No Preference', 'No Preference', 'Kevin', 2995, 3),

(19, 6, 1, 'No Preference', 'No Preference', 'Danny', 599, 3),
(20, 6, 2, 'No Preference', 'No Preference', 'Kevin', 2995, 3);
...
(2, 2, 26955, "Anuj", "4111111111111112", 0),
(1, 3, 3594, "Anuj", "4111111111111111", 0),
(2, 4, 3594, "Anuj", "4111111111111112", 0),
(1, 5, 3594, "Anuj", "4111111111111111", 0),
(2, 6, 3594, "Anuj", "4111111111111112", 0),
(1, 5, -2516, "Anuj", "4111111111111111", 0),
(2, 6, -2516, "Anuj", "4111111111111112", 0);

INSERT INTO points (date_created, date_modified,user_id,billing_id,amount,reason) VALUES
(now(), now(), 1, 3, 3594, "Points Reward"),
(now(), now(), 2, 4, 3594, "Points Reward");
