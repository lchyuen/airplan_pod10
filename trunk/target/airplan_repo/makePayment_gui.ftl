				...
				<div class="content-1024">
					<div class="col-1024">
						...
						<legend>Reservation Details</legend>
							<form name="form1" method="get" action="makePayment.action">
								...
								<div class="inputs-wide">
									...
									<p><input name="creditCardNum" class="textbox-gen" id="creditCardNum" type="number" min="1000000000000000" max="9999999999999999" /></p>
