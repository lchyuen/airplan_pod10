				...
				<div class="content-1024">
					<div class="col-1024">
						...
						<legend>Ticket Details</legend>
							<form name="form1" method="get" onsubmit="return isEmpty()" action="modifyTicket.action">
								...
								<div class="inputs-wide">
									...
									<p><input name="passengerName" class="textbox-gen" id="passengerName" type="text" required /></p>
