						...
						<legend>Search for Return Flight</legend>
							<form name="form1" method="get" onsubmit="return isEmpty()" action="searchFlightsLoop.action">
								...
								<div class="inputs">
									...
									<input name="destination" class="textbox-gen places" id="destination" value=${destination} type="text" required />
									<input name="origin" class="textbox-gen places" id="origin" value=${origin} type="text" required />
